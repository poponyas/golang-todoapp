...
// @Success 200 {object} GetTasksResponse "Успешное получение списка пользователей"
...
func (h *TasksHTTPHandler) GetTasks(rw http.ResponseWriter, r *http.Request) {
	...
	user_id, limit, offset, err := getUserIDLimitOffsetQueryParams(r)
	if err != nil {
	...
	tasksDomains, err := h.tasksService.GetTasks(ctx, user_id, limit, offset)
	if err != nil {
		responseHandler.ErrorResponse(
			err,
			"failed to get tasks",
